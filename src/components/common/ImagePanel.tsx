  ...
  return (
    <div className="bg-card border border-border rounded-lg p-4">
      ...
      <div className="flex items-center gap-2 mb-3">
        <Camera className="w-4 h-4 text-industrial-red" />
        <h3 className="text-sm font-medium text-industrial-red">{title}</h3>
      </div>
      ...
      <div className="relative">
        ...
        {/* Image Area */}
        <div className="h-[100px] bg-muted border border-border rounded flex items-center justify-center overflow-hidden">
          {images.length > 0 ? (
            <img
